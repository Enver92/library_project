...
class Genre(models.Model):
    ...
    """
    name = models.CharField(max_length=200, help_text="Enter a book genre (e.g. Science Fiction, Russian Novel etc.)")
...
class Language(models.Model):
    lang = models.CharField(max_length=40, help_text="Enter the book's natural language.")
